...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// 2-3. 배열 요소 값 대입
		// arr은 int[] 참조형 변수이지만
		// arr[0]~[2] int 자료형 변수이기 때문에 정수값을 대입할 수 있다.
	...
	public void ex4() {
		...
		for(int i = 0; i < score.length - 1 ; i++) {
			if(score[i] > max) { // 처음 100 > 100 false 라서 max = 100 초기화 값 그대로
				max = score[i];
			} else if(score[i] < min) {
				min = score[i];
			} 
	...
	public void ex5() {
		...
		// 가각 'A','B','C','D','E'로 초기화 후 주소를 arr3에 대입
